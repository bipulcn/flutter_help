...
class BlockData extends ChangeNotifier {
  ...
  /*
bipul-test
public: 0x6ff37f60651a216f6E5EEb29425744a963B17248
private: 20db46c52bbde1b44fe1d5d38cdd21390210466ca0dd011387ee25b99de6c089
  */
  ...
  Future<void> saveUser(String name, int age) async {
    ...
    EthereumAddress contractAddress =
        EthereumAddress.fromHex(constants.CONTRACT_ADDRESS);
    // Take this abi and address to get the deployed contract
    ...
    final credentials =
        await client.credentialsFromPrivateKey(priKey.address.toString());
    debugPrint(priKey.address.toString());
    debugPrint(credentials.address.toString());
    String res = await client.sendTransaction(
      credentials,
      Transaction.callContract(
        contract: contract,
        function: contract.function("addUser"),
        parameters: [name, BigInt.from(age).toUnsigned(4)],
      ),
    );
