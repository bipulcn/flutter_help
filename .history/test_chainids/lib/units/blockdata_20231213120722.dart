...
class BlockData extends ChangeNotifier {
  ...
  Future<double> getBalace() async {
    ...
    var keys = EthereumAddress.fromHex("0x6ff37f60651a216f6E5EEb29425744a963B17248");
...
/*
    ...
    */
    ...
    var cred = EthPrivateKey.fromHex(
        "20db46c52bbde1b44fe1d5d38cdd21390210466ca0dd011387ee25b99de6c089");
    var rece = EthPrivateKey.fromHex(
        "89ab5353ef092aa0982cd02d47aedaada5c71fc55030b09ecd7472f846ec3723");
    await _client!.sendTransaction(
      cred,
      Transaction(
        from: cred.address,
